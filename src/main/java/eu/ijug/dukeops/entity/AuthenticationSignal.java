...
public class AuthenticationSignal {
    ...
    private final @NotNull ValueSignal<Boolean> admin = new ValueSignal<>(Boolean.class);
    ...
    public boolean isAuthenticated() {
        return TRUE.equals(authenticated.value());
    }
    ...
    public boolean isAdmin() {
        return isAuthenticated() && TRUE.equals(admin.value());
    }
