...
public interface RecordWithTimestamps {
     ...
     *
     * @param value the {@link LocalDateTime} when the record was created
     */
    void setCreated(@NotNull LocalDateTime value);
     ...
     */
    @NotNull LocalDateTime getCreated();

    /**
     * <p>Sets the last update timestamp for this record.</p>
     *
     * @param value the {@link LocalDateTime} of the last update
     */
    void setUpdated(@NotNull LocalDateTime value);
     ...
     */
    @NotNull LocalDateTime getUpdated();
